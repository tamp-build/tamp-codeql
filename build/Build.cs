...
#pragma warning restore CS0649
    ...
    readonly string SonarProjectKey = "tamp-build_tamp-codeql";
    ...
    Target Test => _ => _
        ...
        .Description("Unit tests only — integration tests need codeql CLI on PATH.")
        .Executes(() => DotNet.Test(s => s
            .SetProject(RootDirectory / "tests" / "Tamp.CodeQL.V2.Tests" / "Tamp.CodeQL.V2.Tests.csproj")
            .SetConfiguration(Configuration)
            .SetNoBuild(true)
    ...
    Target Pack => _ => _
        ...
        {
            s.SetProject(RootDirectory / "src" / "Tamp.CodeQL.V2" / "Tamp.CodeQL.V2.csproj");
